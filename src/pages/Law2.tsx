...
export default function Law2() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <div>
        <h1 className="text-3xl font-bold text-gray-900">The 2nd Law: Make It Attractive</h1>
        <p className="mt-2 text-lg text-gray-600">
          Use temptation bundling and motivation rituals to make habits irresistible.
        </p>
      </div>

      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <h2 className="text-xl font-semibold text-gray-900 mb-4">Temptation Bundling</h2>
        <div className="prose prose-indigo max-w-none text-gray-600 mb-6">
          <p>
            Pair an action you <em>want</em> to do with an action you <em>need</em> to do.
            <br/>
            <strong>Formula:</strong> After [HABIT I NEED], I will [HABIT I WANT].
          </p>
        </div>
          ...
          {goodHabits.map((habit) => (
            <div key={habit.id} className="border-b border-gray-100 pb-4 last:border-0 last:pb-0">
              ...
              <div className="flex flex-col sm:flex-row gap-2 items-center">
                <span className="text-sm text-gray-500 whitespace-nowrap">After I do this, I get to:</span>
                <input
                  type="text"
                  value={habit.craving || ''}
                  onChange={(e) => handleUpdateHabit(habit.id, 'craving', e.target.value)}
                  placeholder="e.g., watch 1 episode of Netflix"
